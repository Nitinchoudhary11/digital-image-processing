...
def create_rectangles(M, N, border, n, w1, w2, alpha, orientation, Vf=[0], Vb=[255]):
    ...
    cv2.imwrite('final_image1.jpg', image_bg)       # Save Image into the same location that of the program
...
def main():
    ...
    orientation = [1, 2]    # uniformly distributed orientation of rectangle [portrait, landscape]
